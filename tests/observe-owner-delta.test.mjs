...
async function fixture(t, size = 1) {
  ...
  const task = runtime.propose(owner, mission.id, { workstreamId: stream.id, title: 'Implement module', objective: 'Read updates', kind: 'implementation', scope: ['src/'], acceptance: ['works'], checks: ['test'] })
