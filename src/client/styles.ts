...
body:not([data-ds-dark-theme]) [data-swarm] .sw-head{background:linear-gradient(135deg,#e0f1e8,#f2f7f5)}body:not([data-ds-dark-theme]) [data-swarm] .sw-objective{color:var(--sw-muted)}body:not([data-ds-dark-theme]) [data-swarm] .sw-metric{background:var(--sw-card)}
...
@container(max-width:540px){[data-swarm-panel] .sw-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}[data-swarm-panel] .sw-head{padding:16px}[data-swarm-panel] h2{font-size:19px}[data-swarm-panel] .sw-body{padding:12px}[data-swarm-panel] .sw-board{grid-template-columns:minmax(0,1fr);overflow:visible}[data-swarm-panel] .sw-lane-title{min-height:20px;margin-bottom:5px}[data-swarm-panel] .sw-empty{padding:9px}[data-swarm-panel] .sw-contract,[data-swarm-panel] .sw-fields{grid-template-columns:minmax(0,1fr)}[data-swarm-panel] .sw-budget-fields{grid-template-columns:repeat(2,minmax(0,1fr))}[data-swarm-panel] .sw-tabs{padding:10px 8px;gap:2px}[data-swarm-panel] .sw-tab{padding:6px 8px}}
...
[data-swarm] .sw-focus[data-stale=true]{border-style:dashed}
...
[data-swarm] .sw-technical{margin:0 18px}[data-swarm] .sw-detail-objective{padding:12px 0}[data-swarm] .sw-technical .sw-metrics{border:1px solid var(--sw-border);border-radius:8px;overflow:hidden}
...
@container(max-width:380px){[data-swarm-panel] .sw-overview{padding:14px 12px 0}[data-swarm-panel] .sw-technical{margin:0 12px}[data-swarm-panel] .sw-head{padding:16px 12px 0}}
...
/* Task lanes and cancellation cause chips. */
