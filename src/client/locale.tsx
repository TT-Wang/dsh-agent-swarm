...
export const zh: Record<string, string> = {
  ...
  'Recorded elapsed': '记录时已持续', 'Activity signal': '运行信号', 'ago': '前',
  'Show fewer members': '收起成员', 'Show all members': '查看全部成员', 'Other members': '其他成员',
  'Recent activity': '实时动态', 'Recorded events only': '只显示实际事件', 'Verification in progress': '验证处理中',
  'Waiting for work': '等待任务推进', 'Ready for work': '准备就绪', 'Waiting for provider recovery': '等待模型服务恢复',
  'Tool result recorded': '已收到工具结果', 'Tool reported an error': '工具返回错误',
  'No recent runtime signal. Execution is unconfirmed; this does not mean the task has stopped.': '暂未收到新的运行信号，执行情况待确认；这不代表后台任务已经停止。',
  'Saved requests': '已保存的请求', 'Collaboration start stopped': '协作启动已停止',
  'Retry this request': '重试这次任务', 'Stop starting': '停止启动',
  'The request timed out. Its outcome is unconfirmed. Refresh the state before retrying.': '请求超时，结果尚未确认。请先刷新状态，再决定是否重试。',
  'Check application status': '查询应用状态', 'No application receipt yet. Check the state again before retrying.': '尚未收到应用回执，请先查询状态，避免重复应用。',
  'Waiting for the main agent': '待主 agent 处理',
  'Latest recorded work': '最近一次实际推进',
  'Since operation started': '距开始',
  'No successful application receipt was found. You can explicitly retry applying the result.': '未查询到成功应用回执。你可以再次点击应用结果重试。',
  'The selected mission was not returned. Refresh the state before retrying.': '未查询到当前任务，请刷新状态后再试。',
  ...
  'quiescence-recovered': '静止后已恢复', 'review-retired': '审查已退役', 'superseded': '已被替代', 'duplicate-carrier': '重复承担', 'effort-downgraded': '推理强度已降级',
